...
public class EmpDao {
	...
	public static Connection getConnection(){
		...
		con=DriverManager.getConnection("jdbc:mysql://localhost:3306/adidb","root","root");
		Statement s = con.createStatement();
		ResultSet r = s.executeQuery("select * from user905");
		/*Class.forName("com.mysql.jdbc.Driver");
			Connection c = DriverManager.getConnection("jdbc:mysql://localhost:3306/adithyadb","root","adithya");
